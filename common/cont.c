...
CONT g_conts[] = {
	{ N_("South America"), CONTINENTE_AMERICASUR, CONT_AMERICASUR_CANT, 4 },
	{ N_("North America"), CONTINENTE_AMERICANORTE, CONT_AMERICANORTE_CANT, 6 },
	{ N_("Africa"), CONTINENTE_AFRICA, CONT_AFRICA_CANT, 4},
	{ N_("Oceania"), CONTINENTE_OCEANIA, CONT_OCEANIA_CANT, 3 },
	{ N_("Europe"), CONTINENTE_EUROPA, CONT_EUROPA_CANT, 8 },
	{ N_("Asia"), CONTINENTE_ASIA, CONT_ASIA_CANT, 8 },
	{ N_("Central America"), CONTINENTE_AMERICACENTRO, CONT_AMERICACENTRO_CANT, 3 },
};
