...
#define TARJETA_NULL_SUPERTARJETA { {NULL,NULL}, TARJ_SUPERTARJETA, -1, FALSE }
...
typedef enum {
	...
	TARJ_SUPERTARJETA = 64,		/**< valor de la supertarjeta */
} TARJTIPO, *PTARJTIPO;
...
typedef struct _tarjeta {
	...
	BOOLEAN usada;			/**< si se pusieron las 3 fichas del country */
} TARJETA, *PTARJETA;
